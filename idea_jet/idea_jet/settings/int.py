...
STATICFILES_DIRS = [
    os.path.join("/applications/idea_jet/venv/lib/python/3.10/site-packages/", "idea_jet_static"),
    os.path.join("/applications/idea_jet/venv/lib/python/3.10/site-packages/", "idea_jet_business/templates")
]